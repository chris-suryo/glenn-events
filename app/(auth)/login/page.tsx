        ...
        <CardContent>
          ...
          <div className="mt-5">
            ...
            <button
              ...
              className="mt-4 w-full flex items-center justify-center gap-2.5 rounded-md border bg-background px-4 py-2 text-sm font-medium hover:bg-muted transition-colors shadow-[0px_1px_2px_rgba(0,0,0,0.05)]"
            >
