...
async function run() {
  ...
  await supabase.from('timeline_items').insert([
    ...
    {
      event_id: eid,
      title: 'AV soundcheck & rehearsal',
      description: 'Mic check, slide deck, and walk-through with SoundWave.',
      type: 'task',
      starts_at: new Date('2026-09-27T17:00:00-04:00').toISOString(),
      ends_at: new Date('2026-09-27T17:30:00-04:00').toISOString(),
    },
    {
      event_id: eid,
      title: 'Guest arrival & welcome reception',
      description: 'Doors open, registration, passed drinks on the terrace.',
      type: 'planning',
      starts_at: new Date('2026-09-27T18:00:00-04:00').toISOString(),
      ends_at: new Date('2026-09-27T18:45:00-04:00').toISOString(),
    },
    {
      event_id: eid,
      title: 'Dinner service',
      description: 'Plated three-course dinner.',
      type: 'milestone',
      starts_at: new Date('2026-09-27T19:00:00-04:00').toISOString(),
      ends_at: new Date('2026-09-27T20:15:00-04:00').toISOString(),
    },
    {
      event_id: eid,
      title: 'Client remarks & product preview',
      description: 'Welcome from leadership + a short Q4 product preview.',
      type: 'milestone',
      starts_at: new Date('2026-09-27T20:15:00-04:00').toISOString(),
      ends_at: new Date('2026-09-27T20:45:00-04:00').toISOString(),
    },
    {
      event_id: eid,
      title: 'Dessert & networking',
      description: 'Dessert stations, coffee, and open networking.',
      type: 'planning',
      starts_at: new Date('2026-09-27T20:45:00-04:00').toISOString(),
